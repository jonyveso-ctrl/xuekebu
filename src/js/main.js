		...
		setTimeout(() => {
			...
			if (canvas) {
				const gridAnimation = new GridAnimation(canvas, {
					...
					borderColor: "rgba(64, 86, 161, 0.4)",
					squareSize: isPhone ? 50 : 40,
					hoverFillColor: "rgba(100, 255, 218, 0.8)",
					hoverShadowColor: "rgba(100, 255, 218, 0.8)",
					transitionDuration: 200,
					trailDuration: 1500,
					specialBlockColor: "rgba(100, 255, 218, 0.8)",
					specialHoverColor: "rgba(0, 174, 255, 0.8)",
					// 蛇身颜色渐变配置
					snakeHeadColor: "rgba(0, 174, 255, 0.95)",
					snakeTailColor: "rgba(0, 119, 204, 0.25)",
